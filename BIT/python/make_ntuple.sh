...
#python $CMSSW_BASE/src/Analysis/MVA/python/make_ntuple.py  --output /groups/hephy/cms/$USER/BIT/training-ntuple-WH --sample WJetsToLNu_HT --config_module TMB.BIT.configs  --config WH_delphes_bkgs_ptW200
