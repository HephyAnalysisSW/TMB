...
ttG_noFullyHad_test = FWLiteSample.fromDirectory("ttG_noFullyHad_test", "/eos/vbc/experiments/cms/store/user/schoef/ttG_test/ttG_test/210214_071742/0000/")
ttG_noFullyHad_test.reweight_pkl = os.path.join(gridpack_directory, "v6", "ttG_noFullyHad_test_ctZ_slc7_amd64_gcc700_CMSSW_10_6_0_tarball.pkl")
ttG_noFullyHad_test.xsec    = 1.947
ttG_noFullyHad_test.nEvents = 3972000

ttg_noFullyHad_test2 = FWLiteSample.fromDirectory("ttg_noFullyHad_test2", "/eos/vbc/experiments/cms/store/user/schoef/ttG_test_2/ttG_test_2/210215_112202/0000/")
ttg_noFullyHad_test2.reweight_pkl = os.path.join(gridpack_directory, "v6", "ttg_noFullyHad_slc7_amd64_gcc700_CMSSW_10_6_0_tarball.pkl")
ttg_noFullyHad_test2.xsec    = 1.947
ttg_noFullyHad_test2.nEvents = 3972000
