...
argParser.add_argument('--output_directory',   action='store', type=str,   default='/groups/hephy/cms/robert.schoefbeck/TMB/models/')
argParser.add_argument('--input_directory',    action='store', type=str,   default=os.path.expandvars("/eos/vbc/group/cms/$USER/TMB/training-ntuples-tttt-v2/MVA-training/") )
