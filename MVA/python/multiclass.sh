#python multiclass.py --name tttt_3l_ttw_ttz_nonprompt_v3 --input_directory /scratch-cbe/users/rosmarie.schoefbeck/TMB/training-ntuples-tttt-v3/MVA-training/ --config tttt_3l --output_directory /mnt/hephy/cms/rosmarie.schoefbeck/TMB/models 
#python multiclass.py --name tttt_3l_ttw_ttz_nonprompt_v3 --input_directory /scratch-cbe/users/rosmarie.schoefbeck/TMB/training-ntuples-tttt-v3/MVA-training/ --config tttt_3l --output_directory /mnt/hephy/cms/rosmarie.schoefbeck/TMB/models --add_LSTM 
