...
python genPostProcessing.py --targetDir v1 --overwrite --addReweights --logLevel INFO --interpolationOrder 2  --sample WW #SPLIT100 
python genPostProcessing.py --targetDir v1 --overwrite --addReweights --logLevel INFO --interpolationOrder 2  --sample WZ #SPLIT100 
python genPostProcessing.py --targetDir v1 --overwrite --addReweights --logLevel INFO --interpolationOrder 2  --sample ZZ #SPLIT100 
python genPostProcessing.py --targetDir v1 --overwrite --addReweights --logLevel INFO --interpolationOrder 2  --sample WWW #SPLIT200
python genPostProcessing.py --targetDir v1 --overwrite --addReweights --logLevel INFO --interpolationOrder 2  --sample WWZ #SPLIT200
python genPostProcessing.py --targetDir v1 --overwrite --addReweights --logLevel INFO --interpolationOrder 2  --sample WZZ #SPLIT200
python genPostProcessing.py --targetDir v1 --overwrite --addReweights --logLevel INFO --interpolationOrder 2  --sample ZZZ #SPLIT200
