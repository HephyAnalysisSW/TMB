...
#
python genPostProcessing.py --overwrite target --miniAOD --delphesEra RunII --targetDir v10 --logLevel INFO  --sample DYBBJetsToLL_M50_LO #SPLIT145
python genPostProcessing.py --overwrite target --miniAOD --delphesEra RunII --targetDir v10 --logLevel INFO  --sample DYJetsToLL_M50_HT70to100_LO #SPLIT237
python genPostProcessing.py --overwrite target --miniAOD --delphesEra RunII --targetDir v10 --logLevel INFO  --sample DYJetsToLL_M50_HT100to200_LO #SPLIT232
python genPostProcessing.py --overwrite target --miniAOD --delphesEra RunII --targetDir v10 --logLevel INFO  --sample DYJetsToLL_M50_HT200to400_LO #SPLIT311
python genPostProcessing.py --overwrite target --miniAOD --delphesEra RunII --targetDir v10 --logLevel INFO  --sample DYJetsToLL_M50_HT400to600_LO_ext2 #SPLIT253
python genPostProcessing.py --overwrite target --miniAOD --delphesEra RunII --targetDir v10 --logLevel INFO  --sample DYJetsToLL_M50_HT600to800_LO #SPLIT264
python genPostProcessing.py --overwrite target --miniAOD --delphesEra RunII --targetDir v10 --logLevel INFO  --sample DYJetsToLL_M50_HT800to1200_LO #SPLIT109
python genPostProcessing.py --overwrite target --miniAOD --delphesEra RunII --targetDir v10 --logLevel INFO  --sample DYJetsToLL_M50_HT1200to2500_LO #SPLIT23
python genPostProcessing.py --overwrite target --miniAOD --delphesEra RunII --targetDir v10 --logLevel INFO  --sample DYJetsToLL_M50_HT2500toInf_LO #SPLIT23

python genPostProcessing.py --overwrite target --delphesEra RunII --targetDir v10 --logLevel INFO  --sample DYJets #SPLIT595
